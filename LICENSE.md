...
**2.2 Patent license.** Subject to the same conditions, each Rights Holder/Contributor grants You a worldwide, royalty-free, non-exclusive, irrevocable (except under Section 2.3) patent license to make, use, sell, offer to sell, and import the Compiler, Components, Contributions, and Derivative Works, limited to claims necessarily infringed by: (a) a Rights Holder's Component alone or combined with the Compiler into which it is incorporated, or (b) a Contributor's Contribution(s) alone or combined with the Compiler or Component to which it was submitted.

No one grants rights it does not own or control.

**2.3 Termination on patent suit.** If You bring a patent infringement claim alleging that the Compiler, a Component, a Contribution, or a Derivative Work infringes a patent You own, Your patent rights under this License terminate as of that filing, but only as to the specific material at issue, and only Your patent rights (not copyright rights, and not rights to unrelated material).
...
TO THE MAXIMUM EXTENT PERMITTED BY LAW, NO RIGHTS HOLDER OR CONTRIBUTOR IS LIABLE FOR ANY CLAIM, LOSS, DAMAGE, OR OTHER LIABILITY (CONTRACT, TORT, OR OTHERWISE) ARISING FROM THE COMPILER, ANY COMPONENT, CONTRIBUTION, DERIVATIVE WORK, ANY OUTPUT THEY PRODUCE, OR ANY USE OF OR DEALING WITH ANY OF THE FOREGOING.
...
If a Compiler, during compilation, includes a portion of a Library, the resulting work shall be exempt from the distribution conditions of Section 3 of the License. This exemption extends only to the Compiler's output.
